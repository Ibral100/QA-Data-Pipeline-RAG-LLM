...
- 🎨 **Theme Selection**: Choose from available themes in MinIO
- 🤖 **Model Selection**: Select an installed Ollama model
- 💬 **Interactive Chat**: Ask questions and get contextual answers
- 📝 **History**: Keep track of previous conversations
- 🔍 **Transparency**: View source comments used for generation

---

## 🔒 Security

> ⚠️ **Important**: Before pushing this code to production, make sure to:
...
<p align="center">
  Made with ❤️ for the Data Science & NLP community
</p>
